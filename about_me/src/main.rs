...
/*
  To compile this program: use `cargo build` to compile the project,
  `cargo run` to compile and run the project, or `cargo check` to
  check for errors without producing an executable.
*/
fn main() {
    println!("Hello, my name is Miguel.");
    println!("I enjoy learning new programming languages.");
    println!(
        "In my free time, I like to tinker with tech projects, explore new music, and watch sci-fi movies."
    );
}
